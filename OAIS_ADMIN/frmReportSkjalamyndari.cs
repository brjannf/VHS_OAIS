...
{
    public partial class frmReportSkjalamyndari : Form
    {
        cNotandi virkurnotandi = new cNotandi();
        private readonly ReportViewer reportViewer;
        string m_strAuðkenni = string.Empty;
        cStillingar stillingar = new cStillingar();
        public frmReportSkjalamyndari()
        {
            InitializeComponent();
        }
        public frmReportSkjalamyndari(string strAuðkenni, cNotandi virkur)
        {
            InitializeComponent();
            ...
            localReport.ReportPath = "repSkjalamyndari.rdlc";
        ...
        private void frmLoad(object sender, EventArgs e)
        {
            ...
            DataTable dt = skjalm.utgafurSkjalamyndara(m_strAuðkenni);
            ...
            rr["varsla_heiti"] = "Samtals:";
            rr["verd"] = iVerd + " krónur";
            rr["staerd"] = FormatBytes(heild);
            dtCloned.Rows.Add(rr);
            dtCloned.AcceptChanges();
            ReportDataSource reportDataSource = new ReportDataSource("dtSkjalm", dtCloned);
